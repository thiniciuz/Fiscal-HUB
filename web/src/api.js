...
export const api = {
  ...
  login: (nome, senha) => request("/auth/login", { method: "POST", body: JSON.stringify({ nome, senha }) }),
  ...
  listUpcomingTasks: (userId, days = 7) =>
    request(`/tasks/upcoming?user_id=${userId}&days=${days}`),
  listTaskComments: (taskId, userId) =>
